...
const files=new Set(['style.css','app.js','games.js','engine.js','audio.js','racing.js','racing.svg','aviation.js','bike.svg','aviation.svg','tank.svg','snake.svg','hero.svg','favicon.svg','social.svg','social.png']);
...
export const server=http.createServer(async(req,res)=>{
 ...
 if(p==='/')return page('Free online arcade games',home(settings),200,{ads:true,description:'Play tank, snake, car racing, bike racing and fast aviation games free on ixegames. Instant browser games with keyboard and touch controls. No downloads or player accounts.'});
