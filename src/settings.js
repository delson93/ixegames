...
export const defaults = {siteName:'ixegames',tagline:'Small breaks. Big plays.',contactEmail:'',operatorName:'',announcement:'Five games. A whole arcade on the way.',tankEnabled:true,snakeEnabled:true,racingEnabled:true,bikeEnabled:true,aviationEnabled:true,adsEnabled:false,publisherId:'',topSlot:'',bottomSlot:'',cmpReady:false,topImage:'',topLink:'',topAlt:'',bottomImage:'',bottomLink:'',bottomAlt:''};
